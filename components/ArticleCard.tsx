...
const ArticleCard = ({
  ...
  return (
    <Link href={link} target="_blank" rel="noopener noreferrer">
      <Card className={cn("group min-h-80 flex flex-col rounded-3xl h-full text-primary hover:bg-primary hover:text-background font-audio p-2 space-y-4", "md:space-y-8", "lg:space-y-10 lg:min-h-96", "xl:space-y-14 xl:min-h-[400px]")}>
